...
.sexy-ride { grid-template-columns: 68px 1fr 78px 12px !important; min-height: 78px !important; border-radius: 16px !important; gap:10px!important; }
